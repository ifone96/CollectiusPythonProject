...
data_file_folder = "Z:\\MIS\\Fone Wasin\\Python\\Call Activities\\SMN Call\\"
df = []
...
sql_cmd_LPC =   """
                ...
                --Change The Date '2022-01-01 00:00:00.000'
                AND phone_call.createdon >= '2022-11-02 00:00:00.000' 
                AND phone_call.createdon <= '2022-11-03 00:00:00.000'
...
sql_cmd_PTP =   """
                ...
                WHERE a.alternis_portfolioidname IN ('SEAMONEY SPL SVC TH','SEAMONEY BCL SVC TH')
                --Change The Date '2022-01-01 00:00:00.000'
                AND p.alternis_firstpaymentdate >= '2022-11-03 00:00:00.000'
...
todaysdate_filename = str(
    datetime.datetime.now().strftime("SPayLater-UNC Daily report as of %Y-%m-%d")) + '.xlsx'
